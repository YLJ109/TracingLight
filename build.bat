...
setlocal
cd /d "%~dp0"
title TracingLight - Build

echo ================================================
echo   TracingLight - Build
echo   Builds the production bundle, then you can start.
echo ================================================
...
:skip_pull
echo [2/3] Skipping git pull. Run "build.bat pull" to fetch latest first.
